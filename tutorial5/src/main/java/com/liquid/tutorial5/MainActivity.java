...
import com.liquid.tutorial5.databinding.ActivityMainBinding;
import com.liquid.tutorial5.entity.Customer;
import com.liquid.tutorial5.viewmodel.CustomerViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // we make sure that AndroidViewModelFactory creates the view model so it
        // can accept the Application as the parameter
        customerViewModel = ViewModelProvider.AndroidViewModelFactory.getInstance(getApplication())
